...
- <a href="#copyright">著作物の利用について</a>を一読すること。
...
必ず「**利用規約**」があるので、確認しましょう。
（実際に、**利用規約を読まずに使われて、裁判になった例もあり**ます。）

利用する場合は、以下の観点を見るようにしましょう。
- **商用利用が可能**か
- **引用元の表記などは必要**か
- **画像を加工しても良いか（記載ない場合は原則禁止）**

<br/>

### ネットで拾った画像は使わない。他者の画像を使いたい場合は許可をとる。

google画像検索やWebサイト上に**アップロードされている画像を無断で使うのは原則禁止**。
