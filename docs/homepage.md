...
- <a href="#aboutCopyright">著作物の利用について</a>を一読すること。
...
必ず「**<span style="color:red;">利用規約</a>**」があるので、確認しましょう。
（実際に、**利用規約を読まずに使われて、裁判になった例もあり**ます。）

利用する場合は、以下の観点を見るようにしましょう。
- **<span style="color:red;">商用利用が可能</a>**か
- **<span style="color:red;">引用元の表記などは必要</a>**か
